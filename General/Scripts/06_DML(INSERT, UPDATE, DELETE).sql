...
--> 명시되지 않은 컬럼 5개에는 NULL또는 설정된 기본값 대입
...
/* EMP_M01을 기준으로 하여 EMP_M02를 병합 
 * 1) 같음을 판별할 컬럼 기준 작성
 * 		 -> ON(EMP_M91.EMP_ID = EMP_M02.EMP_ID)
 * 
...
/* MARGE의 INSERT 에는 INTO 빠져있다
 * 이미 위에 적혀있기 때문 
 * MERGE 선언부에 "INTO EMP_M01"이 이미 작성되서 */
