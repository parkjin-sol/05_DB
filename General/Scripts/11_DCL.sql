...
CREATE USER TEST11_USER
IDENTIFIED BY "TEST1234";

-- CREAT SESSION 권한을 가지고 있지 않음;
-- 로그온이 거절되었습니다
 ...
 * 
 */
GRANT CREATE SESSION TO TEST11_USER;
--> 연결 확인

/* 생성돤 사용자 계정으로 접속(TEST11_USER) */
...
/* TEST11_USER에게 테이블 생성 공간 할당
 * 
 * */
ALTER USER TEST11_USER
DEFAULT TABLESPACE USERS
QUOTA 10M ON USERS;

/* 다시 TEST11_USER 계정 접속*/

CREATE TABLE TEST_TABLE (ANONYMOUS
	TEST_NO NUMBER 
);
---------------------------------------
...
/* 객체 권한 부여*/
SELECT *
FROM KH11_PJS.EMPLOYEE;  --> 없어서 조회 X
